...
namespace vMenuClient.menus
{
    public class SavedVehicles
    {
        ...
        private readonly Menu vehicleCategoryMenu = new(" ", "Manage Saved Vehicles");
        private readonly Menu savedVehiclesCategoryMenu = new(" ", "I get updated at runtime!");
        private readonly Menu selectedVehicleMenu = new(" ", "Manage this saved vehicle.");
        private readonly Menu unavailableVehiclesMenu = new(" ", "Unavailable Saved Vehicles");
        ...
        private void CreateClassMenu()
        {
            ...
            // Create the menu.
            classMenu = new Menu(menuTitle, " ");

            for (var i = 0; i < 23; i++)
            {
                var categoryMenu = new Menu(" ", GetLabelText($"VEH_CLASS_{i}"));
        ...
        {
            savedVehicleTypeMenu = new(" ", "Select from class or custom category");
