...
namespace vMenuClient.menus
{
    public class VehicleSpawner
    {
        ...
        private void CreateMenu()
        {
            ...
            // Vehicle Addons List
            var addonCarsMenu = new Menu(" ", "Spawn An Addon Vehicle");
            ...
            if (IsAllowed(Permission.VSAddon))
            {
                if (AddonVehicles != null)
                {
                    if (AddonVehicles.Count > 0)
                    {
                        ...
                        var unavailableCars = new Menu(" ", "Unavailable Vehicles");
                        ...
                        {
                            var categoryMenu = new Menu(" ", GetLabelText($"VEH_CLASS_{cat}"));
