...
namespace vMenuClient.menus
{
    public class PlayerAppearance
    {
        ...
        private readonly Menu mainPedsMenu = new(" ", "Spawn A Ped");
        private readonly Menu animalsPedsMenu = new("Animals", "Spawn A Ped");
        private readonly Menu malePedsMenu = new(" ", "Spawn A Ped");
        private readonly Menu femalePedsMenu = new(" ", "Spawn A Ped");
        private readonly Menu otherPedsMenu = new(" ", "Spawn A Ped");
        ...
        private void CreateMenu()
        {
            ...
            var selectedSavedPedMenu = new Menu(" ", "renameme");
