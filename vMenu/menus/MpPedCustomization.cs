...
namespace vMenuClient.menus
{
    public class MpPedCustomization
    {
        // Variables
        private Menu menu;
        public Menu createCharacterMenu = new(" ", "Create A New Character");
        public Menu savedCharactersMenu = new(" ", "Manage Saved Characters");
        public Menu savedCharactersCategoryMenu = new(" ", "I get updated at runtime!");
        public Menu inheritanceMenu = new(" ", "Character Inheritance Options");
        public Menu appearanceMenu = new(" ", "Character Appearance Options");
        public Menu faceShapeMenu = new(" ", "Character Face Shape Options");
        public Menu tattoosMenu = new(" ", "Character Tattoo Options");
        public Menu clothesMenu = new(" ", "Character Clothing Options");
        public Menu propsMenu = new(" ", "Character Props Options");
        private readonly Menu manageSavedCharacterMenu = new(" ", "Manage MP Character");
